...
@Component
public class PageInfoMain {
	private int currentPage; 	// 현재 페이지 번호를 표시할 변수
	private int listCount = 10; 		// 전체 게시글 수
	private int limit = 10; 		// 한 페이지에 보여질 게시글 수
	private int pageSize = 1; 	// 보여질 페이징바의 페이지 개수
	...
	public PageInfoMain(int currentPage) {
		super();
		this.currentPage = currentPage;
		//전체 개수 10개로 값이 정해져 있음
		makePageInfo();
	}



	public PageInfoMain(int currentPage, int listCount) {
		this.currentPage = currentPage;
