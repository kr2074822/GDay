...
@Component
public class MagazinePageInfo {
	private int currentPage; 	// 현재 페이지 번호를 표시할 변수
	private int listCount; 		// 전체 게시글 수
	private int limit = 6; 			// 한 페이지에 보여질 게시글 수
	private int pageSize = 6; 	// 보여질 페이징바의 페이지 개수
	...
	public MagazinePageInfo() {}
	
	public MagazinePageInfo(int currentPage, int listCount) {
	...
	public MagazinePageInfo(int currentPage, int listCount, int limit, int pagingBarSize, int boardType) {
		super();
		this.currentPage = currentPage;
		this.listCount = listCount;
		this.limit = limit;
